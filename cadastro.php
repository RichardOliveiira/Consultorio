...
function valida_campos()
	{
		...
		if(document.getElementById('crm_usu').value == '')
			{
				alert('Por favor, preencha os campos obrigatórios.');
				document.getElementById('crm_usu').focus();
				return false;

		if(document.getElementById('idade_usu').value == '')
			{
				alert('Por favor, preencha os campos obrigatórios.');
				document.getElementById('idade_usu').focus();
				return false;
...
<br>
	* CRM<br>
	<input type="text" name="crm_usu" id="crm_usu">
<br>
	* Idade<br>
	<input type="text" name="idade_usu" id="idade_usu">
<br>
	* Confirmar senha
    <br>
